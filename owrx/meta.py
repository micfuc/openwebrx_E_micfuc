...
class DigihamEnricher(Enricher, metaclass=ABCMeta):
    def parseCoordinate(self, meta, mode):
        ...
        if callsign is not None and "lat" in meta and "lon" in meta:
            ...
            Map.getSharedInstance().updateLocation(callsign, loc, mode, '' , '' , self.parser.getBand())  # by I8FUC 20230327 added new direct placeholder parameter
        return meta
                ...
                if "data" in dprsData:
                    ...
                    if "lat" in data and "lon" in data:
                        ...
                        if "ourcall" in meta:
                            ...
                            Map.getSharedInstance().updateLocation(meta["ourcall"], loc, "DPRS", '' , '' ,self.parser.getBand()) # by I8FUC 20230327
            except Exception:

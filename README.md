...
The files here have been developed on a working OpenwebRX v1.1 using an RTL-SDR V3. It works reasonably well with 2-3 users on a Pi4 (that's already doing other things).
